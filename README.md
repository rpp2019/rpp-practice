...
- Naredbom **git clone https://github.com/rpp2019/rpp-practice.git**  
...
- **git remote add origin https://github.com/rva2019/IMXX-XXXX-Prezime-Ime** - dodaje putanju do GitHub repozitorijuma (zameniti url sa url-om vašeg repozitorijuma)
